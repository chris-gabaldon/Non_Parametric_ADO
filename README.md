...
## Figures:
This folder contains specific scripts for reproducing each simulation shown in the article. Each script is named FigN.py, where N corresponds to the figure number in the manuscript. Running any of these scripts will automatically generate the corresponding plot.
