...
# simple tutorial to use the ado algorithm with a gaussian prior
...
# step 4: define your discretization and generate the model , set the ones appropiated for your experiment
...
# step 6 : meassure at this point, and update the model using the experiments result (if the experiment has binary results y=1 or y=0)
